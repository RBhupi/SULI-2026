...
from core.queary_engine import QueryEngine
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, db, engine):
        ...
        self.database_tab = DatabaseExplorerTab(self.db, self.engine)
        self.cell_tab = CellExplorerTab(self.db, self.engine)
        self.event_tab = EventExplorerTab(self.db, self.engine)
        self.lightning_tab = LightningExplorerTab(self.db, self.engine)
        self.dashboard_tab = DashboardTab(self.db, self.engine)
    ...
    def open_database(self):
        ...
        try:
            ...
            self.cell_tab.reload_table()
            self.event_tab.reload_table()
            self.lightning_tab.reload_table()
    ...
    def cell_selected(self, cell_uid):
        ...
        self.cell_tab.select_cell(cell_uid)
